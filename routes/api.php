...
Route::get('airquality/classe_qualita/{classe_qualità}', [AirQualityController::class, 'filterByClasseQualita']);
Route::post('airquality/coordinates', [AirQualityController::class, 'filterByCoordinates']);
Route::get('airquality/comune/{comune}/classe_qualità/{classe_qualita}', [AirQualityController::class, 'filterByComuneAndClasseQualita']);
